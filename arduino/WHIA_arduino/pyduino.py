...
Modified from Ferrazzo Riccardo <f.riccardo87@gmail.com>
...
class Arduino:
    ...
    def __init__(self, port):
        self.sp = serial.Serial(port, 115200, timeout=1.5)
        # Allow 2 secs for Diecimila auto-reset to happen
        time.sleep(2)
        
        # Empty all messages sent wen connecting to the arduino
        while True:
            x = self.sp.read()
            if x == "":
                break
